...
import work1 from './images/state1.png';
import work2 from './images/state2.png';
import work3 from './images/state3.png';
import work4 from './images/state4.png';
    ...
    render() {
        ...
        >
          this is key 1
                ...
                {/* <div id="textTable" >สถานะงาน</div> */}

                <div id = "CarouselStateTable" >
                    <Carousel autoplay>
...
const CheckCustomerOrderPage_ = Form.create({ name: 'CheckCustomer_OrderPage' })(CheckCustomerOrderPage);
export default Form.create()(CheckCustomerOrderPage_);